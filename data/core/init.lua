...
local function new_perf_frame_stats()
  return {
    ...
    line_hint_ms = 0,
    line_hint_get_ms = 0,
    line_hint_normalize_ms = 0,
    line_hint_layout_ms = 0,
    line_hint_measure_ms = 0,
    line_hint_truncate_ms = 0,
    line_hint_draw_ms = 0,
    line_hint_draw_text_calls = 0,
    line_hint_draw_text_ms = 0,
    line_hint_skip_no_hint = 0,
    line_hint_skip_no_space = 0,
    line_hint_skip_truncated = 0,
    filetree_line_hint_calls = 0,
    filetree_line_hint_ms = 0,
    filetree_line_hint_get_file_info_calls = 0,
    filetree_line_hint_get_file_info_ms = 0,
    filetree_line_hint_format_ms = 0,
    filetree_line_hint_git_ms = 0,
    filetree_line_hint_segments = 0,
    filetree_line_hint_cache_hits = 0,
    filetree_line_hint_cache_misses = 0,
    filetree_line_hint_folder_count_hits = 0,
    filetree_line_hint_folder_count_pending = 0,
    filetree_line_hint_entry_calls = 0,
    filetree_line_hint_entry_ms = 0,
    filetree_line_hint_entry_rebuilds = 0,
    filetree_line_hint_entry_build_ms = 0,
    filetree_folder_row_background_calls = 0,
    filetree_folder_row_background_rects = 0,
    filetree_folder_row_background_ms = 0,
    filetree_line_is_dir_calls = 0,
    filetree_line_is_dir_ms = 0,
    filetree_draw_line_body_calls = 0,
    filetree_draw_line_body_ms = 0,
    filetree_draw_line_text_calls = 0,
    filetree_draw_line_text_ms = 0,
    filetree_draw_line_text_git_ms = 0,
    filetree_draw_line_text_colored_calls = 0,
    filetree_draw_line_text_plain_calls = 0,
    lsp_render_tokens_calls = 0,
    lsp_render_tokens_ms = 0,
    lsp_render_tokens_matching_ms = 0,
    lsp_render_tokens_capability_ms = 0,
    lsp_render_tokens_latest_ms = 0,
    lsp_render_tokens_cache_hits = 0,
    lsp_render_tokens_cache_misses = 0,
    lsp_render_tokens_line_offsets_ms = 0,
    lsp_render_tokens_line_offsets_lines = 0,
    lsp_render_tokens_scan_ms = 0,
    lsp_render_tokens_scan_tokens = 0,
    lsp_render_tokens_spans = 0,
    lsp_render_tokens_base_ms = 0,
    lsp_render_tokens_overlay_ms = 0,
    lsp_render_tokens_schedule_calls = 0,
    visible_lines = 0,
    text_lines = 0,
    tokens = 0,
    draw_text_calls = 0,
...
function core.run_step(options)
  ...
  core.performance_snapshot = {
    ...
    filetree_line_hint_entry_rebuilds = docview_stats.filetree_line_hint_entry_rebuilds,
    filetree_line_hint_entry_build_ms = docview_stats.filetree_line_hint_entry_build_ms,
