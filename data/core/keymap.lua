...
keymap.add_direct {
  ...
  ["ctrl+x"] = "doc:cut",
  ["ctrl+c"] = "doc:copy",
  ["ctrl+v"] = { "markdown-live-preview:table-paste", "doc:paste" },
  ["insert"] = "doc:toggle-overwrite",
  ["ctrl+insert"] = "doc:copy",
  ["shift+insert"] = { "markdown-live-preview:table-paste", "doc:paste" },
  ["escape"] = { "command:escape", "doc:select-none", "dialog:select-no" },
  ["tab"] = { "command:complete", "markdown-live-preview:table-next-cell", "doc:indent" },
  ["shift+tab"] = { "markdown-live-preview:table-previous-cell", "doc:unindent" },
  ["backspace"] = { "markdown-live-preview:table-backspace", "doc:backspace" },
  ["shift+backspace"] = { "markdown-live-preview:table-backspace", "doc:backspace" },
  ["ctrl+backspace"] = "doc:delete-to-previous-word-start",
  ["ctrl+shift+backspace"] = "doc:delete-to-previous-word-start",
  ["delete"] = { "markdown-live-preview:table-delete", "doc:delete" },
  ["shift+delete"] = { "markdown-live-preview:table-delete", "doc:delete" },
  ["ctrl+delete"] = "doc:delete-to-next-word-end",
  ["ctrl+shift+delete"] = "doc:delete-to-next-word-end",
  ["return"] = { "command:submit", "markdown-live-preview:table-cell-below", "doc:newline", "dialog:select" },
  ["keypad enter"] = { "command:submit", "markdown-live-preview:table-cell-below", "doc:newline", "dialog:select" },
  ...
  ["left"] = { "markdown-live-preview:table-previous-char", "doc:move-to-previous-char", "dialog:previous-entry" },
  ["right"] = { "markdown-live-preview:table-next-char", "doc:move-to-next-char", "dialog:next-entry"},
  ["up"] = { "command:select-previous", "markdown-live-preview:table-cell-up", "doc:move-to-previous-line" },
  ["down"] = { "command:select-next", "markdown-live-preview:table-cell-down", "doc:move-to-next-line" },
  ...
  ["mclick"] = { "markdown-live-preview:table-paste-primary", "doc:paste-primary-selection" },
  ["shift+left"] = { "markdown-live-preview:table-select-previous-char", "doc:select-to-previous-char" },
  ["shift+right"] = { "markdown-live-preview:table-select-next-char", "doc:select-to-next-char" },
  ["shift+up"] = { "markdown-live-preview:table-select-up", "doc:select-to-previous-line" },
  ["shift+down"] = { "markdown-live-preview:table-select-down", "doc:select-to-next-line" },
