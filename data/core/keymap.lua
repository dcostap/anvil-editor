...
keymap.add_direct {
  ...
  ["ctrl+alt+z"] = "editor:revert_file_change",
  ...
  ["ctrl+0"] = "pane:split_right",
  ["ctrl+9"] = "pane:split_down",
  ...
  ["ctrl+keypad enter"] = { "markdown:alternate_list_item_checkbox", "core:newline_below" },
  ["ctrl+shift+return"] = "core:newline_above",
  ["ctrl+j"] = "editor:join_lines",
  ["ctrl+a"] = "core:select_all",
  ["space"] = "core:toggle_selected_row_marks",
  ...
  ["ctrl+shift+l"] = "editor:add_all_matching_selections",
