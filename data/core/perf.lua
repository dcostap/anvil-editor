...
local diagnostic_frame_keys = {
  ...
  "treesitter_project_chunk_adoption_chunks",
  "treesitter_project_chunk_adoption_files",
  "treesitter_project_chunk_adoption_records",
  "treesitter_project_chunk_adoption_ms",
  "treesitter_project_chunk_adoption_max_ms",
  "treesitter_project_chunk_metadata_ms",
  "treesitter_project_chunk_metadata_max_ms",
  "treesitter_project_chunk_replace_ms",
  "treesitter_project_chunk_replace_max_ms",
  "treesitter_project_chunk_aggregate_check_ms",
  "treesitter_project_chunk_aggregate_check_max_ms",
  "treesitter_project_chunk_aggregate_rebuilt",
  "treesitter_project_chunk_aggregate_deferred",
  "treesitter_project_metadata_cache_hits",
  "treesitter_project_metadata_cache_misses",
  "treesitter_project_final_prune_ms",
  "treesitter_project_final_prune_max_ms",
  "treesitter_project_final_aggregate_deferred",
  "treesitter_project_symbols_final_prune_ms",
  "treesitter_project_symbols_final_aggregate_deferred",
  "treesitter_project_chunk_redraws",
  "treesitter_project_aggregate_rebuilds",
  "treesitter_project_aggregate_rebuild_ms",
  "treesitter_project_aggregate_rebuild_max_ms",
  "treesitter_project_aggregate_symbols_sorted",
  "treesitter_project_aggregate_usages_sorted",
  "docview_update_ms",
  ...
  if snapshot.did_redraw then
    ...
    if total_ms > 25 or frame_ms > 20 or present_ms > 18 then
      ...
      slow[#slow + 1] = {
        ...
        treesitter_project_chunk_adoption_ms = snapshot.treesitter_project_chunk_adoption_ms or 0,
        treesitter_project_chunk_metadata_ms = snapshot.treesitter_project_chunk_metadata_ms or 0,
        treesitter_project_aggregate_rebuild_ms = snapshot.treesitter_project_aggregate_rebuild_ms or 0,
        treesitter_project_chunk_adoption_files = snapshot.treesitter_project_chunk_adoption_files or 0,
        treesitter_project_chunk_adoption_records = snapshot.treesitter_project_chunk_adoption_records or 0,
...
local function write_summary(path)
  ...
  for _, row in ipairs(record.slow_frames or {}) do
    file:write(string.format(
      ...
      row.treesitter_project_chunk_adoption_ms, row.treesitter_project_chunk_metadata_ms,
      row.treesitter_project_aggregate_rebuild_ms,
      row.treesitter_project_chunk_adoption_files, row.treesitter_project_chunk_adoption_records,
