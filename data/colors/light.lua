...
style.diff_marker_delete = { common.color "rgba(204, 109, 118, 0.58)" }
style.diff_marker_insert = { common.color "rgba(89, 151, 104, 0.52)" }
style.diff_marker_modify = { common.color "rgba(98, 133, 175, 0.50)" }
...
style.search_selection_secondary = c("d9e8dc")
style.search_selection_secondary_outline = c("86aa8e")
...
style.titlebar_group_indicator = { common.color "rgba(53, 116, 240, 0.60)" }
...
style.fuzzy_searcher_result_selection_background = { common.color "rgba(36, 112, 220, 0.13)" }
style.fuzzy_searcher_result_hover_background = { common.color "rgba(36, 112, 220, 0.07)" }
