...
style.diff_marker_delete = { common.color "rgba(201, 101, 111, 0.58)" }
style.diff_marker_insert = { common.color "rgba(80, 146, 96, 0.52)" }
style.diff_marker_modify = { common.color "rgba(90, 127, 171, 0.50)" }
