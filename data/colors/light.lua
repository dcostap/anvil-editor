...
style.fuzzy_searcher_result_selection_background = { common.color "rgba(36, 112, 220, 0.20)" }
style.fuzzy_searcher_result_hover_background = { common.color "rgba(36, 112, 220, 0.16)" }
