...
style.pane_command_bar = c("26282b")
style.pane_command_bar_hover = { 255, 255, 255, 12 }
style.pane_command_bar_text = c(C.text_fg)
style.pane_command_bar_dim = c(C.ignored)
