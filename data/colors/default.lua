...
style.fuzzy_searcher_result_selection_background = { common.color "rgba(89, 160, 250, 0.20)" }
style.fuzzy_searcher_result_hover_background = { common.color "rgba(89, 160, 250, 0.16)" }
