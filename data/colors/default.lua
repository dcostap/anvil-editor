...
style.diff_marker_delete = { common.color "rgba(214, 117, 126, 0.72)" }
style.diff_marker_insert = { common.color "rgba(117, 177, 131, 0.68)" }
style.diff_marker_modify = { common.color "rgba(112, 154, 200, 0.68)" }
