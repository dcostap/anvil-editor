...
style.row_selection = { common.color "rgba(126, 174, 235, 0.22)" }
style.row_selection_inactive = { common.color "rgba(126, 174, 235, 0.08)" }
...
style.image_grid_bright = c("34373D")
style.image_grid_dark = c("2B2E34")
