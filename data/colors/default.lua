...
style.interactive_hover_background = { common.color "rgba(89, 160, 250, 0.18)" }
style.interactive_hover_overlay = { common.color "rgba(89, 160, 250, 0.12)" }
style.interactive_hover_border = c("b8f5ff")
...
style.markdown_live_callout_palette = {
  ...
  info     = { accent = c("4aa8ff"), background = c("1d2d3b") },
  todo     = { accent = c("4aa8ff"), background = c("1d2d3b") },
  tip      = { accent = c("45c6b7"), background = c("1c312f") },
  success  = { accent = c("63c174"), background = c("203226") },
  question = { accent = c("d6b84b"), background = c("35301e") },
  warning  = { accent = c("e39b45"), background = c("382a1d") },
  failure  = { accent = c("db6b76"), background = c("382225") },
  danger   = { accent = c("e05260"), background = c("3a2024") },
  bug      = { accent = c("d95c8a"), background = c("37212c") },
...
style.diff_marker_delete = { common.color "rgba(219, 132, 140, 0.72)" }
style.diff_marker_insert = { common.color "rgba(132, 185, 143, 0.68)" }
style.diff_marker_modify = { common.color "rgba(126, 164, 207, 0.68)" }
style.diff_overview_delete = { common.color "rgba(210, 105, 115, 0.58)" }
style.diff_overview_insert = { common.color "rgba(105, 170, 120, 0.54)" }
style.diff_overview_modify = { common.color "rgba(100, 145, 195, 0.54)" }
...
style.fuzzy_searcher_result_selection_background = { common.color "rgba(89, 160, 250, 0.13)" }
style.fuzzy_searcher_result_hover_background = { common.color "rgba(89, 160, 250, 0.07)" }
...
style.gitdiff_overview_min_height = math.max(4, common.round(4 * SCALE))
style.git_graph_colors = {
  c("59a0fa"), c("6aab73"), c("c77dff"), c("d6a84b"), c("dc6b86"), c("54b8b0"),
}
style.git_ref_head = c("6aab73")
style.git_ref_branch = c("59a0fa")
style.git_ref_remote = c("c77dff")
style.git_ref_tag = c("d6a84b")
...
style.filetree_git_status_modified = c("5a82aa")
