...
style.diff_marker_delete = { common.color "rgba(216, 124, 132, 0.72)" }
style.diff_marker_insert = { common.color "rgba(124, 181, 137, 0.68)" }
style.diff_marker_modify = { common.color "rgba(119, 159, 203, 0.68)" }
