...
- Lifecycle diagnostics. **Initial opt-in native diagnostics implemented behind `ANVIL_TREE_SITTER_LOG=1` for query compile/cache hits and background parse schedule/apply/discard events.**
