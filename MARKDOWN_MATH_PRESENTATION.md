...
No runtime web renderer, remote script, MathJax process, or HTML surface is introduced. True rendered math still requires the bundled/native TeX layout strategy and security review specified in `plans/done/MARKDOWN_LIVE_EDITOR_PLAN.md`; until then, this source treatment is the intentional supported behavior.
