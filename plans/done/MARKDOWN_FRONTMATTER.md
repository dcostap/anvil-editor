...
This milestone deliberately does not provide typed property controls. Rich property rows require a source-preserving YAML parser and the widget focus/editing contract described in `plans/done/MARKDOWN_LIVE_EDITOR_PLAN.md`.
