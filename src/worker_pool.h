...
typedef struct AnvilWorkerJobSpec {
  ...
  const char *const *project_query_parent_names;
  uint32_t project_query_parent_name_count;
  const char *const *project_query_languages;
  uint32_t project_query_language_count;
  const char *const *project_query_included_paths;
...
uint32_t anvil_worker_result_invalid_text_files_skipped(const AnvilWorkerResult *result);
uint32_t anvil_worker_result_io_files_skipped(const AnvilWorkerResult *result);
uint32_t anvil_worker_result_parse_files_skipped(const AnvilWorkerResult *result);
const char *anvil_worker_result_first_skipped_path(const AnvilWorkerResult *result);
const char *anvil_worker_result_first_skipped_reason(const AnvilWorkerResult *result);
...
bool anvil_worker_result_has_project_symbol_query(const AnvilWorkerResult *result);
uint32_t anvil_worker_result_project_symbol_query_count(const AnvilWorkerResult *result);
uint32_t anvil_worker_result_project_symbol_query_total(const AnvilWorkerResult *result);
bool anvil_worker_result_project_symbol_query_has_more(const AnvilWorkerResult *result);
double anvil_worker_result_project_symbol_query_ms(const AnvilWorkerResult *result);
