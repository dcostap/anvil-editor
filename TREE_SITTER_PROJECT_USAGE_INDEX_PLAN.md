...
- Regression tests for Project-wide Kotlin usages, declaration filtering, eager indexing, live overlays, cap-skipped files, targeted disk-backed reindexing, and directory dirty refresh.
