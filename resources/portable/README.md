...
* `$XDG_CONFIG_HOME/anvil` - Linux or any OS that follows the XDG specification
* `$HOME/.config/anvil` - Any Unix based system (macOS, FreeBSD, etc...)
* `$USERPROFILE/.config/anvil` - Windows
