...
Focused tests cover cooperative cold indexing across multiple yield batches, readiness events, note/heading/block/attachment/URL resolution, ambiguity, aliases, unsaved edits, Project ownership, rename/move behavior, distinct status styling, semantic rendering, and lifecycle regressions.
