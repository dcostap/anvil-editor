...
static int test_apply_single_batch_edit(void) {
  ...
  CHECK(result.edit_descriptor_count == 1);
  CHECK(result.edit_descriptors[0].cursor_index == 0);
  CHECK(result.edit_descriptors[0].old_start_offset == 1);
  CHECK(result.edit_descriptors[0].old_end_offset == 2);
  CHECK(result.edit_descriptors[0].new_start_offset == 1);
  CHECK(result.edit_descriptors[0].new_end_offset == 4);
  CHECK(result.edit_descriptors[0].old_start_point.line == 0);
  CHECK(result.edit_descriptors[0].old_start_point.col == 1);
  CHECK(result.edit_descriptors[0].old_end_point.line == 0);
  CHECK(result.edit_descriptors[0].old_end_point.col == 2);
  CHECK(result.edit_descriptors[0].new_start_point.line == 0);
  CHECK(result.edit_descriptors[0].new_start_point.col == 1);
  CHECK(result.edit_descriptors[0].new_end_point.line == 0);
  CHECK(result.edit_descriptors[0].new_end_point.col == 4);
  CHECK(buffer_is_dirty(&buffer));
...
static int test_apply_multiple_pre_edit_coordinate_edits(void) {
  ...
  CHECK(result.edit_descriptor_count == 3);
  CHECK(result.edit_descriptors[1].cursor_index == 1);
  CHECK(result.edit_descriptors[1].old_start_offset == 5);
  CHECK(result.edit_descriptors[1].old_end_offset == 6);
  CHECK(result.edit_descriptors[1].new_start_offset == 5);
  CHECK(result.edit_descriptors[1].new_end_offset == 7);
  CHECK(result.edit_descriptors[1].old_start_point.line == 1);
  CHECK(result.edit_descriptors[1].old_start_point.col == 1);
  CHECK(result.edit_descriptors[1].old_end_point.line == 1);
  CHECK(result.edit_descriptors[1].old_end_point.col == 2);
  CHECK(result.edit_descriptors[1].new_start_point.line == 1);
  CHECK(result.edit_descriptors[1].new_start_point.col == 1);
  CHECK(result.edit_descriptors[1].new_end_point.line == 1);
  CHECK(result.edit_descriptors[1].new_end_point.col == 3);
